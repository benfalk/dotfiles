...
require('packer').startup(function(use)
  ...
  -- Hate me all you want, I like having nerd-tree to look at a project
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust',
                       'typescript', 'help', 'vim', 'ruby', 'markdown',
                       'json' },
...
local on_attach = function(_, bufnr)
  ...
  -- when your cursor is on a symbol it will highlight all
  -- other occurenes of it
  vim.cmd [[
